...
function MyProfile() {
    ...
    return (
        <div className='text-black p-4 lg:w-[100%]border'>
            <div className='font-Inter px-4'>
                {/* todo - add paths */}
                {/* <div>
                <div>Home/Dashboard/{}</div>
            </div> */}
                <h1 className='text-3xl font-[500] text-slate-900'>My Profile</h1>
            </div>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div>
                        <IconBtn
                            text={"Edit"}
                            onclick={() => { navigate("/dashboard/settings") }}
                            customClasses={'bg-yellow-50 flex flex-row-reverse justify-center items-center text-[14px] font-[500] gap-2 p-1 px-3 rounded-md'}
                            children={<FaRegEdit />}
                        />
                    </div>
                </div>
